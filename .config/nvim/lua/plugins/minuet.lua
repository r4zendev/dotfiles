return {
  ...
  opts = function()
    ...
    local qwen_fim = function(pref, suff, opts)
      ...
      return vc_ctx .. file_ctx .. "<|fim_prefix|>" .. pref .. "<|fim_suffix|>" .. suff .. "<|fim_middle|>"
    end

    local active_provider = "cerebras"
      ...
      local_qwen = {
        ...
        provider_options = {
          openai_fim_compatible = {
            ...
            stream = true,
            name = "Qwen Local",
            optional = { max_tokens = 128, top_p = 0.9, temperature = 0.1 },
            template = { prompt = qwen_fim, suffix = false },
          },
        },
      },
