...
modal:bind({ "cmd", "shift" }, "m", function()
  run("toggle")
end)
modal:bind({ "cmd", "shift" }, "r", function()
  run("random")
end)
modal:bind({ "cmd", "shift" }, "w", function()
  toggle("toggle-nsfw", "nsfw")
end)
modal:bind({ "cmd", "shift" }, "t", function()
  toggle("toggle-restricted", "restricted")
end)
modal:bind({ "cmd", "shift" }, "e", function()
  toggle("toggle-explicit", "explicit")
end)
modal:bind({ "cmd", "shift" }, "d", function()
  toggle("toggle-default", "exclude_default")
end)
modal:bind({ "cmd", "shift" }, "i", function()
  run("show", false)
end)
